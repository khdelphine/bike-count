...
# Make sure the dataframe contains only rows for the current year
bcDataOrig <- bcDataOrig[bcDataOrig$"Year" == currentYear, ]
...
bcData2 <- bcData[c("Record ID",	"Inters And Direc ID", "Bridge vs Roads",	"Intersection",	"Street",	"Direction", "Date",	"Time",	"AM PM",	"Year",	"Facility for Street", "Total Count", "Bikes Per Hour Projected", "Num of Directions in Intersection",	"Bike Count for Intersec (* 8 or * 4)", "Male Count", "Female Count",  "With Traffic Male",	"With Traffic Female",	"Sidewalk Male", "Sidewalk Female", "Wrong Way Male",	"Wrong Way Female", 	"Helmet Male",	"Helmet Female",	"Bikes Share Users", 	"Bike Share Sidewalk Wrong Way",	"Bikes on Buses")]
